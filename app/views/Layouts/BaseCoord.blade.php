...
<div class="wrapper">
    ...
    <div class="sidebar-wrapper"><!-- div sidebar-wrapper -->
            <div class="logo">
                ...
                <center>
                    <label class="text-primary">{{ Auth::userCoord()->get()->Nombre.' '.Auth::userCoord()->get()->Apellidos }}</label>
                </center>
                <br>
                @if(!empty($imagenPerfil))
                    <center>{{ HTML::image('imagenPERFILcoord/'.$imagenPerfil, "", array('class' => 'thumbnail', 'width' => '60px', 'height' => '62px')) }}</center>
                @else
            ...
            <ul class="nav"><!-- div nav -->
                ...
                <li @yield('li-FilesIn')>
                    <a href="{{ route('viewFilesIn.coordinador') }}">
                        <i class="glyphicon glyphicon-save-file"></i>
                        <p>Elementos recibidos</p>
                    </a>
                </li>
                <li @yield('li-FilesOut')>
                    <a href="{{ route('viewFilesOut.coordinador') }}">
                        <i class="glyphicon glyphicon-open-file"></i>
                        <p>Elementos enviados</p>
                    </a>
                </li>
                <li @yield('li-myClients')>
                    <a href="{{ route('viewMyClients.coordinador') }}">
                        <i class="ti-view-list-alt"></i>
                        <p>Consultar clientes</p>
                    </a>
                </li>
                <li @yield('li-Statistics')>
                    <a href="{{ route('viewStatistics.coordinador') }}">
                        <i class="glyphicon glyphicon-stats"></i>
                        <p>Mis estadísticas</p>
                    </a>
                </li>
                 <li @yield('li-userProfile')>
                    <a href="{{ route('userProfile.coordinador') }}">
                        <i class="ti-user"></i>
                        <p>Perfil de usuario</p>
                    </a>
                </li>
                <li @yield('li-NewFile')>
                    <a href="{{ route('Logout.coordinador') }}">
            ...
            <div class="container-fluid"><!-- div container-fluid -->
                ...
                <div class="collapse navbar-collapse"><!-- div collapse navbar-collapse -->
                    <ul class="nav navbar-nav navbar-right"><!-- ul nav  navbar-nav navbar-right-->
                        ...
                        <li>
                            <a href="{{ route('userProfile.coordinador') }}" title="Autenticado">
                                <font color="#28B592"><i class="ti-user"></i>
                                <p>{{ Auth::userCoord()->get()->Nombre.' '.Auth::userCoord()->get()->Apellidos }}</p>
                                </font>
                            </a>
                        </li>                        
                        <li>
                            <a href="{{ route('changeMyPassword.coordinador') }}" title="Configuración de la contraseña">
        ...
        <footer class="footer">
            <div class="container-fluid"><!-- div container-fluid -->
                ...
                <div class="copyright pull-right">
                    ...
                    <a href="{{ route('acercaDeveloped.Coordinador') }}">Ramírez Medellín, S.C. - TIC's</a>
                </div>

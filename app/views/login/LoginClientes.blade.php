...
<script type="text/javascript">
           function ver_password() {
                         var input_form = document.FormLoginCliente.password;
 
                         if (document.FormLoginCliente.input_ver.checked) 
                         {
    	    ...
    	    <div class="col-xs-12">
                ...
                <div class="panel panel-primary" >
                    <div class="panel-heading">
                        <center><i class="glyphicon glyphicon-lock"></i> Login
                        </center>
                    </div>

            <div class="panel-body" >
            
                <h1>Iniciar sesión con su cuenta de cliente</h1>
                   
                    {{ Form::open( array('url' => 'login/FrmLoginClientes', 'method' => 'POST', 'id' => 'login-form', 'name' => 'FormLoginCliente', 'role' => 'form'))}}

                        <div class="form-group has-feedback has-feedback-left">
                             {{ Form::text('username', null, array('class' => 'form-control', 'placeholder' => 'Nombre de usuario / Username', 'autocomplete'=>'off', 'maxlength' => '13', Input::old('userNameCliente'))) }}

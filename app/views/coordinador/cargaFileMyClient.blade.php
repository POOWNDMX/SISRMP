...
@section('titulo')
         {{ Auth::userCoord()->get()->Nombre.' '.Auth::userCoord()->get()->Apellidos }} | Cargar archivos
@endsection
...
@section('cuerpo')
	...
	@section('tituloPanel')
		Mis clientes <i class="glyphicon glyphicon-chevron-right"></i> Cargar Archivos 
        ...
        <div class="panel panel-primary"> 
            <div class="panel-heading">
                <center>
                    ...
                    <font size="2">{{ $clienteUploading->NombreEmpresa }}</font>
                </center>
            </div>
            ...
            {{ Form::open( array(
                ...
                {{ Form::hidden('clientDestination', $clienteUploading->id) }}

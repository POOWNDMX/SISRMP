...
<div class="container">
    ...
    <h3><span class="glyphicon glyphicon-hdd"></span> Lista de archivos enviados por los clientes -</h3>
  ...
  <!-- MENSAJE DE EXITO EN LA OPERACION -->
    ...
    {{ Form::open(['route' => 'Files.submitCliente', 'method' => 'GET', 'class' => 'navbar-form pull-right', 'role' => 'search', 'autocomplete' => 'off']) }}

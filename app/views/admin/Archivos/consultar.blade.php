...
<div class="container">
    ...
    <h3><span class="glyphicon glyphicon-hdd"></span> Lista de archivos -</h3>
    ...
    {{ Form::open(['route' => 'Files.store', 'method' => 'GET', 'class' => 'navbar-form pull-right', 'role' => 'search', 'autocomplete' => 'off']) }}
          ...
          @if($archivos->count())
            ...
            <thead>
              <tr style="background-color: #B3DACE; color: #000; font-size: 10px;">
                ...
                <th><center> Cooordinador </center></th>
              ...
              <tr>
                ...
                @if($archivo->state != 0)
                    <td>
                      ...
                      <font color="#DA1900">( ELIMINADO POR EL USUARIO ) - </font>
                      <font color="#000000">{{ $archivo->userDelete }}</font><br>
                      <font color="#000000">Fecha:</font>
                      <font color="#DA1900"> {{ $archivo->updated_at }}</font>&nbsp;&nbsp;
                        <font size="3"> 
                          <a href="{{ route('FileStPanelDelete.recovery', [$archivo->Id_File]) }}"title="Recuperar" style="cursor:pointer; cursor: hand">
                            <i class="glyphicon glyphicon-level-up"></i></a>
                        </font>
                    </td>
                    <td style="background: #FFC7BF">{{ $archivo->state }}</td>
                  @else 
                    <td>
                      <a href="{{ route('Files.show', [$archivo->Id_File]) }}" title="{{ $archivo->nameEncrypt }}">
                ...
                <td><center><font color="#005571">{{ $archivo->userSubmit }}</font></center></td>
                <td>
            ...
            <div class="panel panel-info" ><!-- div panel-success -->
              ...
              <div class="panel-body" ><!-- div panel-body -->
                <h5>Argumentos para buscar información en el filtro de búsqueda:</h5><br>
                  ...
                  <p class="pclass">- Por el argumento "submitCoord"</p>
                  <p class="pclass">- Por el argumento "submitClient"</p>

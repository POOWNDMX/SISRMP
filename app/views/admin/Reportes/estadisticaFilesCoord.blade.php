...
@section('titulo')
Estadísticas de archivos | {{ $coordinador->Nombre.' '.$coordinador->Apellidos }}
@endsection
...
@section('tituloReport')
 ...
 <strong>Coordinador: </strong> {{  $coordinador->Nombre.' '.$coordinador->Apellidos}}
@endsection

<main>
  <p>Estadísticas de la tabla de archivos en la base de datos del sistema del coordinador 
  {{  $coordinador->Nombre.' '.$coordinador->Apellidos}}. - [ <strong>{{ $totalFiles }}</strong> ] archivos en total.</p>

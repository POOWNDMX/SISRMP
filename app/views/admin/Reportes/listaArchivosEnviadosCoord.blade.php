...
@section('titulo')
Files | Enviados por Coordinadores
@endsection
...
@section('tituloReport')
 <strong>Reporte:</strong><br> Lista de archivos enviados por coordinadores al {{ $dateAct }}.<br>
  
@endsection

<main>
  <p>
    Lista de archivos alojados en el sistema que fueron enviados por los coordinadores - [{{ $archivos->count() }}] en total
  </p>

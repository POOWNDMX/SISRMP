...
<div class="container">
  <div class="page-header">
    <h3><span class="glyphicon glyphicon-open-file"></span> &nbsp;&nbsp;Archivos enviados del coordinador -</h3>
    ...
    <center>
      ...
      Exportar lista: 
         <a href="{{ route('listaFilesSubmitCoord.view', $coordinador->id) }}" target="_blank" class="linkShow"> 
            PDF <i class="glyphicon glyphicon-file"></i>
        </a>
        &nbsp;&nbsp; | &nbsp;&nbsp;Descarga directa: 
        <a href="{{ route('listaFilesSubmitCoord.download', $coordinador->id) }}" target="_blank" class="linkShow">
            PDF <i class="glyphicon glyphicon-floppy-save"></i>
        </a><br>

        <!-- ENVIAR ID DEL COORDINADOR EN LA URL DE BUSQUEDA -->
        {{ Form::open(['route' => ['Coordinador.filesSubmit', $coordinador->id], 'method' => 'GET', 'class' => 'navbar-form pull-right', 'role' => 'search']) }}
         ...
         <label align="right">
          ...
          <div class="input-group"><!-- div input-group -->
            {{ Form::text('buscar', Input::get('buscar'), array('class' => 'form-control', 'placeholder' => 'Buscar archivo...', 'aria-describedby' => 'search', 'autocomplete' => 'off')) }}
          ...
          @if($archivos->count())
            ...
            <thead>
              <tr style="background-color: #B3DACE; color: #000; font-size: 10px;">
                ...
                <th><center> Cliente Receptor </center></th>
            ...
            <div class="panel panel-info" ><!-- div panel-success -->
              ...
              <div class="panel-body" ><!-- div panel-body -->
                <h5>Argumentos para buscar información en el filtro de búsqueda:</h5><br>
                  ...
                  <p class="pclass">- Por Cliente</p><br>

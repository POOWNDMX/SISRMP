...
<div class="container">
  <div class="page-header">
    <h3><span class="glyphicon glyphicon-save-file"></span> &nbsp;&nbsp;Archivos recibidos del coordinador -</h3>
    ...
    <center>
      ...
      @endif
         ...
         Exportar lista: 
         <a href="{{ route('listaFilesReceivedCoord.view', $coordinador->id) }}" target="_blank" class="linkShow"> 
            PDF <i class="glyphicon glyphicon-file"></i>
        </a>
        &nbsp;&nbsp; | &nbsp;&nbsp;Descarga directa: 
        <a href="{{ route('listaFilesReceivedCoord.download', $coordinador->id) }}" target="_blank" class="linkShow">
            PDF <i class="glyphicon glyphicon-floppy-save"></i>
        </a><br>

        <!-- ENVIAR ID DEL COORDINADOR EN LA URL DE BUSQUEDA -->
        {{ Form::open(['route' => ['Coordinador.filesReceived', $coordinador->id], 'method' => 'GET', 'class' => 'navbar-form pull-right', 'role' => 'search', 'autocomplete' => 'off']) }}

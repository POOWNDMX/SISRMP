...
<div class="container">
  <div class="page-header">
    <h3><span class="glyphicon glyphicon-save-file"></span> &nbsp;&nbsp;Archivos recibidos del cliente -</h3>
    ...
    <center>
      ...
      @endif
         Exportar lista: 
         <a href="{{ route('listaFilesReceivedClient.view', $cliente->id) }}" target="_blank" class="linkShow"> 
            PDF <i class="glyphicon glyphicon-file"></i>
        </a>
        &nbsp;&nbsp; | &nbsp;&nbsp;Descarga directa: 
        <a href="{{ route('listaFilesReceivedClient.download', $cliente->id) }}" target="_blank" class="linkShow">
            PDF <i class="glyphicon glyphicon-floppy-save"></i>
        </a><br>

        <!-- ENVIAR ID DEL COORDINADOR EN LA URL DE BUSQUEDA -->
        {{ Form::open(['route' => ['Cliente.filesReceived', $cliente->id], 'method' => 'GET', 'class' => 'navbar-form pull-right', 'role' => 'search', 'autocomplete' => 'off']) }}
          ...
          @if($archivos->count())
            ...
            <thead>
              <tr style="background-color: #B3DACE; color: #000; font-size: 10px;">
                ...
                <th><center> Coordinador Emisor </center></th>
            ...
            <tr>
                ...
                @if($archivo->userSubmit == 'submitCoord')
                	<td>
                  		<span class="label label-success">Id: {{ $archivo->Id_Cloordinador }}</span><br> 

...
<div class="container">
  <div class="page-header">
    <h3>
    	...
    	</span> &nbsp;&nbsp;Archivos eliminados por algun usuario del cliente -</h3>
  ...
  Exportar lista: 
         <a href="{{ route('listaFilesDeletedClient.view', $cliente->id) }}" target="_blank" class="linkShow"> 
            PDF <i class="glyphicon glyphicon-file"></i>
        </a>
        &nbsp;&nbsp; | &nbsp;&nbsp;Descarga directa: 
        <a href="{{ route('listaFilesDeletedClient.download', $cliente->id) }}" target="_blank" class="linkShow">
            PDF <i class="glyphicon glyphicon-floppy-save"></i>
        </a><br>

        <!-- ENVIAR ID DEL COORDINADOR EN LA URL DE BUSQUEDA -->
        {{ Form::open(['route' => ['Cliente.filesDeleted', $cliente->id], 'method' => 'GET', 'class' => 'navbar-form pull-right', 'role' => 'search', 'autocomplete' => 'off']) }}

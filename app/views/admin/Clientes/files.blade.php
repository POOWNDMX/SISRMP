...
<div class="container">
  <div class="page-header">
    <h3><span class="glyphicon glyphicon-file"></span> &nbsp;&nbsp;Archivos del cliente -</h3>
    ...
    <center>
      ...
      @endif
         ...
         Exportar lista: 
         <a href="{{ route('listaFilesClient.view', $cliente->id) }}" target="_blank" class="linkShow"> 
            PDF <i class="glyphicon glyphicon-file"></i>
        </a>
        &nbsp;&nbsp; | &nbsp;&nbsp;Descarga directa: 
        <a href="{{ route('listaFilesClient.download', $cliente->id) }}" target="_blank" class="linkShow">
            PDF <i class="glyphicon glyphicon-floppy-save"></i>
        </a><br>

        <!-- ENVIAR ID DEL COORDINADOR EN LA URL DE BUSQUEDA -->
        {{ Form::open(['route' => ['Cliente.filesMine', $cliente->id], 'method' => 'GET', 'class' => 'navbar-form pull-right', 'role' => 'search', 'autocomplete' => 'off']) }}
            ...
            <div class="panel panel-info" ><!-- div panel-success -->
              ...
              <div class="panel-body" ><!-- div panel-body -->
                <h5>Argumentos para buscar información en el filtro de búsqueda:</h5><br>
                  ...
                  <p class="pclass">- Por el argumento "submitClient"</p><br>

...
@section('titulo')
         {{ Auth::userCliente()->get()->NombreEmpresa }} | Archivos recibidos
@endsection
...
<div class="content"><!-- div content (general) -->
    <div class="container-fluid"><!-- div container-fluid -->
        ...
        {{ Form::open(['route' => 'viewFilesIn.cliente', 'method' => 'GET', 'class' => 'pull-right', 'role' => 'search']) }}
        ...
        <table class="table table table-condensed table-hover">
            ...
            <thead>
                <tr style="background-color: #ffffff; color: #000;">
                    ...
                    <th><center>Contacto emisor</center></th>
                ...
                @foreach($inFiles as $inFile)
                    <tr>
                        <td style="color: #00768B;">
                            <a href="{{ route('detalleArchivo.cliente', [$inFile->Id_File]) }}" 
                        ...
                        <td><center>{{ $inFile->NombreCoordinador() }}</center></td>
                        <td><center>{{ $inFile->created_at }}</center></td>
                        <td>
                            <a href="{{ route('FileDeleted.Cliente', [$inFile->Id_File]) }}" title="Eliminar archivo" style="cursor:pointer; cursor: hand" onclick="return confirm('¿Seguro de eliminar el archivo?')">
                                <font color="#D00000">
...
@section('message')
        ...
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'ti-wand',
                message: "¡Hola! Bienvenido a tu cuenta de <b>cliente</b> - Te recomendamos cambiar tu contraseña constantemente."

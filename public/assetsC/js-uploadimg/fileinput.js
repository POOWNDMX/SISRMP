...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 2000, // Máximo peso de subida.....
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: 'Remover',
        removeTitle: 'Limpiar los archivos seleccionados',
        cancelLabel: 'Cancel',
        ...
        msgSizeTooLarge: 'El archivo "{name}" (<b>{size} KB</b>) excede el tamaño máximo para la carga de <b>{maxSize} KB</b>.',
/*{files} *///   msgFilesTooLess: '<strong>¡ Error !</strong>Deberás seleccionar <b>{n}</b>  archivo para cargar.',
        msgFilesTooMany: '<strong>¡ Error !</strong>El número de archivos seleccionados para la carga es <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>.',
        ...
        msgInvalidFileExtension: '<strong>¡ Error !</strong> Extensión invalida del archivo "{name}". Solo estas extensiones son soportadas "{extensions}" .',
